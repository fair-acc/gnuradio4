...
struct SyntheticPeakSpectrum : gr::Block<SyntheticPeakSpectrum<T>, gr::Resampling<1LU, 1LU>> {
    ...
    gr::Annotated<T, "peak_width_max_sigma", gr::Doc<"widest physically occurring feature, in bins">>  peak_width_max_sigma = T(250);
    ...
    GR_MAKE_REFLECTABLE(SyntheticPeakSpectrum, in, out, spectrum_size, max_peaks, snr_min_db, snr_max_db, noise_level, peak_width_min_bins, peak_width_max_sigma, width_tail_exponent, dc_feature_prob, dc_amp_max, dc_decay_min_bins, dc_decay_max_bins, add_coloured_noise, add_edge_effects, add_spurious_spikes, seed);
...
private:
    ...
    [[nodiscard]] T sampleWidthBins() {
        const T span = peak_width_max_sigma / peak_width_min_bins;
