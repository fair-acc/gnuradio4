...
const boost::ut::suite DataSinkTests = [] {
    ...
    "callback continuous mode"_test = [] {
        ...
        expect(eq(ConnectionResult::SUCCESS, testGraph.connect2(src, src.out, delay, delay.in)));
        expect(eq(ConnectionResult::SUCCESS, testGraph.connect2(delay, delay.out, sink, sink.in)));
...
#pragma GCC diagnostic pop
    ...
    "data set poller"_test = [] {
        ...
        expect(eq(gr::ConnectionResult::SUCCESS, testGraph.connect2(source, source.out, delay, delay.in)));
        expect(eq(gr::ConnectionResult::SUCCESS, testGraph.connect2(delay, delay.out, streamToDataSet, streamToDataSet.in)));
        expect(eq(gr::ConnectionResult::SUCCESS, testGraph.connect2(streamToDataSet, streamToDataSet.out, sink, sink.in)));
