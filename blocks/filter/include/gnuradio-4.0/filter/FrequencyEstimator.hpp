...
/// estimates signal frequency with the time-domain algorithm of Krajewski, Sienkowski, Miczulski, "A simple and
/// fast algorithm for measuring power system frequency", Measurement 201 (2022),
...
struct FrequencyEstimatorTimeDomain : Block<FrequencyEstimatorTimeDomain<T, Args...>, Args...> {
    using Description = Doc<"estimates signal frequency using a time-domain algorithm">;
...
/// estimates signal frequency with the frequency-domain algorithm of Gasior, Gonzalez, "Improving FFT frequency
/// measurement resolution by parabolic and gaussian spectrum interpolation", AIP Conf. Proc. 732 (2004) 276,
...
struct FrequencyEstimatorFrequencyDomain : Block<FrequencyEstimatorFrequencyDomain<T, Args...>, Args...> {
    using Description = Doc<"estimates signal frequency using a frequency-domain algorithm">;
...
struct IQDemodulator : Block<IQDemodulator<T, Args...>, Args...> {
    using Description = Doc<"digital lock-in amplifier recovering amplitude, phase and frequency from a reference/response pair">;
