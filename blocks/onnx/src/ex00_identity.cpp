...
int main(int argc, char* argv[]) {
    const std::string kDefaultModel = gr::blocks::onnx::test::modelPath("identity_N64.ort");
    ...
    std::println("model input shape:    {}", inference.model_input_shape.value);
    std::println("model output shape:   {}", inference.model_output_shape.value);
