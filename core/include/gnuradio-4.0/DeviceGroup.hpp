...
/**
 * A group of blocks sharing one compute domain, run synchronously by one in-built scheduler from work().
 *
...
/**
 * Wraps an already-built device group into a domain block, exporting every port no interior edge claims.
 *
