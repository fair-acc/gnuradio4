...
public:
    ...
    uint8_t _type_info{0}; // lower 4 bits: ValueType, upper 4 bits: ContainerType
    union Storage {
        bool          b;
        std::int8_t   i8;
        std::int16_t  i16;
...
public:
    ...
    [[nodiscard]] constexpr ValueType     value_type() const noexcept { return static_cast<ValueType>(_type_info & 0x0F); }
    [[nodiscard]] constexpr ContainerType container_type() const noexcept { return static_cast<ContainerType>(_type_info >> 4); }
    ...
    /// Tensor reference access (unchecked).
    /// @pre holds<Tensor<T>>() must be true
    template<typename T>
    [[nodiscard]] Tensor<T>& ref_tensor() noexcept;

    template<typename T>
    [[nodiscard]] const Tensor<T>& ref_tensor() const noexcept;

    /// Map reference access (unchecked).
    /// @pre is_map() must be true
    [[nodiscard]] Map&       ref_map() noexcept;
    [[nodiscard]] const Map& ref_map() const noexcept;

    /// String view access (unchecked, zero-copy).
    /// @pre is_string() must be true
    /// @warning Returns dangling view if Value is modified or destroyed
    [[nodiscard]] std::string_view as_string_view() const noexcept;

    /// String copy access (allocates).
    /// @pre is_string() must be true
...
#define X(T)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    ...
    extern template Tensor<T>&       Value::ref_tensor<T>() noexcept;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
    extern template const Tensor<T>& Value::ref_tensor<T>() const noexcept;
