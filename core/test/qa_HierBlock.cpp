...
protected:
    ...
    make_graph() {
        ...
        _dynamicInputPorts.emplace_back(gr::DynamicPort(gr::inputPort<0, gr::traits::port::port_kind::Stream>(&left_scale_block), gr::DynamicPort::non_owned_reference_tag{}));
        _dynamicInputPorts.emplace_back(gr::DynamicPort(gr::inputPort<0, gr::traits::port::port_kind::Stream>(&right_scale_block), gr::DynamicPort::non_owned_reference_tag{}));
        _dynamicOutputPorts.emplace_back(gr::DynamicPort(gr::outputPort<0, gr::traits::port::port_kind::Stream>(&adder_block), gr::DynamicPort::non_owned_reference_tag{}));
