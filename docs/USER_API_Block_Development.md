...
Reference: [`Block.hpp`](../core/include/gnuradio-4.0/Block.hpp) (`work()` implementation), [`Port.hpp`](../core/include/gnuradio-4.0/Port.hpp) (`streamReader`/`streamWriter`/`tagReader`/`tagWriter`)
