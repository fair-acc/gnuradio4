...
- by contributing, you grant every GR4 user (including commercial users)
  a patent licence covering the code you submit — see
  [LINKING_EXCEPTION.md](LINKING_EXCEPTION.md) for details.
