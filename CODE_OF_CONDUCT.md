...
- Using contributions, reputation, or external influence as leverage to coerce maintainers into unrelated decisions,
  or to retaliate against good-faith review
...
and will take appropriate and fair corrective action in response to any behaviour they deem inappropriate,
...
responsible for enforcement at [fair-c2-admin@gsi.de](mailto:fair-c2-admin@gsi.de).
...
for a specified period of time. This includes avoiding interactions in community spaces as well as external channels
...
for a specified period of time. No public or private interaction with the people involved,
...
inappropriate behaviour, harassment of an individual, or aggression toward or disparagement of classes of individuals.
...
The "leverage / coercion" item under unacceptable behaviour is a project-specific addition and is not part of the
canonical Contributor Covenant text.
