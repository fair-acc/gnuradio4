...
/**
 * The two difference equations a filter evaluates, as functions of the state they are given.
 *
...
struct Iir {
    ...
    /**
     * One sample of the recursion, for a caller that has a sample rather than a span.
     *
...
/**
 * A cascade of sections, each in transposed direct form II.
 *
